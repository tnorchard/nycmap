...
interface Props {
  open: boolean;
  tab: "deeds" | "landlords";
  onTab: (tab: "deeds" | "landlords") => void;
  onClose: () => void;
    ...
    >
      ...
      >
        ...
        <div className="flex gap-1 px-6 pt-4">
          ...
          <TabButton active={tab === "landlords"} onClick={() => onTab("landlords")}>
            Tycoons
          </TabButton>
        </div>
          ...
          {tab === "deeds" ? (
            ...
            <ul className="grid gap-2 sm:grid-cols-2">
              {tycoons.map((o, i) => {
                ...
                return (
                  <li key={o.name} className={`flex items-center gap-3 rounded-2xl border px-3 py-2.5 ${active ? "border-[#141414] bg-[#141414] text-white" : "border-[#eeeae3]"}`}>
